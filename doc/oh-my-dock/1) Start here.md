...
These tutorials will be enough to get you started in depth.
...
- [What is an image?](https://docs.docker.com/get-started/docker-concepts/the-basics/what-is-an-image/ "What is an image?") (Blueprint for Containers)
...
# On what your hand must become dirty ? 

1) How to write Dockerfile
2) How to write Docker-compose
3) Secretes/env handling
4) Docker CLI 
